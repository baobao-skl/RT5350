...
/*
	...
	Arguments:
		...
		FlgIsLocked		1: already lock
		MgmtQid		the queue ID for the action frame
...
//				kfree(Elem);
		...
		IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
		{
			...
			RT_VLAN_8023_HEADER_COPY(pAd, Header802_3, LENGTH_802_3, pPayload, FromWhichBSSID, TPID);
		}
#endif // CONFIG_AP_SUPPORT //
#ifdef CONFIG_STA_SUPPORT
		IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
	...
	IN	UCHAR			FromWhichBSSID)
{
	...
	RT_80211_TO_8023_PACKET(pAd, pRxBlk, Header802_3, FromWhichBSSID, TPID);
...
#ifdef CONFIG_AP_SUPPORT
	IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
		RT_VLAN_PKT_DUPLICATE(pPacket2, pAd, (pData2-LENGTH_802_3), LENGTH_802_3, pData2, Payload2Size, FromWhichBSSID, TPID);
#endif // CONFIG_AP_SUPPORT //
#ifdef CONFIG_STA_SUPPORT
	IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
