...
<table width="540" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
  ...
  <tr align=center> 
    <td width=15px id="storageAdmUserSelect">&nbsp;</td>
    <td id="storageAdmUserName">User Name</td>
    <td id="storageAdmUserFtp">Allow to use FTP</td>
    <td id="storageAdmUserSmb">Allow to use Samba</td>
  </tr>
<script language="JavaScript" type="text/javascript">
