...
{
	var e = document.getElementById("manNTPSet");
	e.innerHTML = _("man ntp setting");
	e = document.getElementById("manNTPIntroduction");
	e.innerHTML = _("man introduction3");
	...
	e = document.getElementById("manNTPTitle");
	e.innerHTML = _("man ntp title");
...
<h1 id="manNTPSet">NTP Settings</h1>
<p id="manNTPIntroduction">You may configure NTP settings here.</p>
<br />
...
<tbody>
	<tr>
  <td colspan="2" id="manNTPTitle" class="title">settings NTP</td>
</tr>
<tr id="div_date">
	<td id="manNTPCurrentTime" class="head">Current Time</td>
	<td class="content">
...
<tr>
  <td id="manNTPTimeZone" class="head">Time Zone:</td>
  <td class="content">
...
<tr>
  <td id="manNTPServer" class="head">NTP Server</td>
  <td class="content"><input size="32" maxlength="64" name="NTPServerIP" value="<% getCfgGeneral(1, "NTPServerIP"); %>" type="text">
...
<tr>
  <td id="manNTPSync" class="head">NTP synchronization</td>
  <td class="content"><input size="4" name="NTPSync" value="<% getCfgGeneral(1, "NTPSync"); %>" type="text"> </td>
</tr>
</tbody></table>
