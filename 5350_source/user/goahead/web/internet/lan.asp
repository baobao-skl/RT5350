...
<tr <% var hashost = getHostSupp();
  ...
  <td id="lHostname" class="head">Hostname</td>
  <td class="content"><input name="hostname" maxlength=16
              value="<% getCfgGeneral(1, "HostName"); %>"></td>
</tr>
<tr>
  <td id="lIp" class="head">IP Address</td>
  <td class="content"><input name="lanIp" maxlength=15 value="<% getLanIp(); %>" onFocus="recIpCfg()" onBlur="modDhcpCfg()"></td>
</tr>
<tr>
  <td id="lNetmask" class="head">Subnet Mask</td>
  <td class="content"><input name="lanNetmask" maxlength=15 value="<% getLanNetmask(); %>"></td>
</tr>
<!--
<tr>
  <td id="lLan2">LAN2</td>
...
<tr id="start">
  <td id="lDhcpStart" class="head">DHCP Start IP</td>
  <td class="content"><input name="dhcpStart" maxlength=15
             value="<% getCfgGeneral(1, "dhcpStart"); %>"></td>
</tr>
<tr id="end">
  <td id="lDhcpEnd" class="head">DHCP End IP</td>
  <td class="content"><input name="dhcpEnd" maxlength=15
             value="<% getCfgGeneral(1, "dhcpEnd"); %>"></td>
</tr>
<!--
<tr id="mask">
  <td id="lDhcpNetmask" align="right">DHCP Subnet Mask</td>
  <td><input name="dhcpMask" maxlength=15
             value="<% getCfgGeneral(1, "dhcpMask"); %>"></td>
</tr>
<tr id="pridns">
  <td id="lDhcpPriDns" align="right">DHCP Primary DNS</td>
  <td><input name="dhcpPriDns" maxlength=15
             value="<% getCfgGeneral(1, "dhcpPriDns"); %>"></td>
</tr>
<tr id="secdns">
  <td id="lDhcpSecDns" align="right">DHCP Secondary DNS</td>
  <td><input name="dhcpSecDns" maxlength=15
             value="<% getCfgGeneral(1, "dhcpSecDns"); %>"></td>
</tr>
<tr id="gateway">
  <td id="lDhcpGateway" align="right">DHCP Default Gateway</td>
  <td><input name="dhcpGateway" maxlength=15
             value="<% getCfgGeneral(1, "dhcpGateway"); %>"></td>
</tr>
-->
<tr id="lease">
  <td id="lDhcpLease" class="head">DHCP Lease Time</td>
  <td class="content"><input name="dhcpLease" maxlength=8
             value="<% getCfgGeneral(1, "dhcpLease"); %>"></td>
</tr>
<!--
<tr id="staticlease1">
  <td id="lDhcpStatic1" align="right">Statically Assigned</td>
...
<tr id="staticlease2">
  <td id="lDhcpStatic2" align="right">Statically Assigned</td>
...
<tr id="staticlease3">
  <td id="lDhcpStatic3" align="right">Statically Assigned</td>
...
<tr>
  <td id="lStp">802.1d Spanning Tree</td>
  <td>
...
-->
<tr id="upnp">
  <td id="lUpnp" class="head">UPNP</td>
  <td class="content">
...
<!--
<tr id="radvd">
  <td id="lRadvd">Router Advertisement</td>
  <td>
...
<tr align="center">
  <td colspan="2" class="content">
  	<input type=submit style="{width:120px;}" value="Apply" id="lApply"  onClick="TimeoutReload(10)">&nbsp;&nbsp;
