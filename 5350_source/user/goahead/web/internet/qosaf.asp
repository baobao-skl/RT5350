...
<table width="540" border="1" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
  ...
  <tr>
    ...
    <td id="QoSAFUploadBandwidth"><input type=text name="af_rate" maxlength=2> % of upload bandwidth</td>
  </tr>
  <tr>
    <td class="head" id="QoSAFCeilStr">Ceil</td>
    <td><input type=text name="af_ceil" maxlength=3> % of upload bandwidth</td>
  </tr>
</table>
