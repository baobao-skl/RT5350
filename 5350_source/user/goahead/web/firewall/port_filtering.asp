...
<tr>
	<td colspan="2" id="portBasicSet" class="title">Basic Settings</td>
</tr>

<tr>
	<td id="portBasicFilter" class="head">
...
<tr>
	<td id="portBasicDefaultPolicy" class="head">
		Default Policy -- The packet that don't match with any rules would be:
	</td>
	<!--<td id="portBasicDefaultPolicyAccept">Accepted</td>-->
...
<table width="500" border="0" cellpadding="2" cellspacing="1">
<tr>
	<td colspan="4" id="portFilterSet" class="title">IP/Port Filter Settings</td>
</tr>

<tr>
	<td colspan="2" id="portFilterMac" class="head">
		Mac address
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="2" id="portFilterDIPAddr" class="head">
		Dest IP Address
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="2" id="portFilterSIPAddr" class="head">
		Source IP Address
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="2" id="portFilterProtocol" class="head">
		Protocol
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="2" id="portFilterDPortRange" class="head">
		Dest. Port Range
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="2" id="portFilterSPortRange" class="head">
		Src Port Range
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="2" id="portFilterAction" class="head">
		Action
	</td>
	<!--<td id="portFilterActionDrop">Drop</td>-->
...
<tr>
	<td colspan="2" id="portFilterComment"  class="head">
		Comment
	</td>
	<td colspan="2" class="content">
...
<tr>
	<td colspan="4" id="portFilterComment" class="content">
...
<table width="500" border="1" cellpadding="2" cellspacing="1">	
	<tr>
		<td colspan="10" id="portCurrentFilter">Current IP/Port filtering rules in system: </td>
	</tr>
