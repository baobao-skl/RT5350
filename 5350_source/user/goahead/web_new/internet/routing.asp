...
<tr id="routingNetmaskRow">
	<td id="routingNetmask" class="head">
		Sub Netmask
	</td>
	<td class="content">
...
<tr>
	<td id="routingGateway" class="head">
		Gateway
	</td>
	<td class="content">
...
<tr>
	<td id="routingInterface" class="head">
		Interface
	</td>
	<td class="content">
...
<tr>
	<td id="routingComment"  class="head">
		Comment
	</td class="content">
...
<table border="1" cellpadding="2" cellspacing="1" width="500">	
	<tbody><tr>
		<td  colspan="10" id="routingCurrentRoutingTableRules"  class="title">Current Routing table in the system: </td>
	</tr>

	<tr>
		<td id="routingNo" class="head"> No.</td>
		<td id="routingDelDest" align="center" class="head"> Destination </td>
		<td id="routingDelNetmask" align="center" class="head"> Netmask</td>
		<td id="routingDelGateway" align="center" class="head"> Gateway</td>
		<td id="routingDelFlags" align="center" class="head"> Flags</td>
		<td id="routingDelMetric" align="center" class="head"> Metric</td>
		<td id="routingDelRef" align="center" class="head"> Ref</td>
		<td id="routingDelUse" align="center" class="head"> Use</td>
		<td id="routingDelInterface" align="center" class="head"> Interface</td>
		<td id="routingDelComment" align="center" class="head"> Comment</td>
	</tr>
	...
	for(i=0; i<entries.length; i++){
		if(category[i] > -1){
			...
			document.write("<tr>");
			document.write("<td class='content'>"); 	document.write(i+1);			 	document.write("</td>");
		}

		document.write("<td class='content'>"); 	wrapDel(destination[i], idle[i]); 	document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(netmask[i], idle[i]);		document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(gateway[i], idle[i]); 		document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(flags[i], idle[i]);			document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(metric[i], idle[i]);		document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(ref[i], idle[i]);			document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(use[i], idle[i]);			document.write("</td>");
		...
		document.write("<td class='content'>"); 	wrapDel(interface[i] + "(" +true_interface[i] + ")", idle[i]);		document.write("</td>");
		document.write("<td class='content'>"); 	wrapDel(comment[i], idle[i]);		document.write("</td>");
		document.write("</tr>\n");
	}
	</script>
