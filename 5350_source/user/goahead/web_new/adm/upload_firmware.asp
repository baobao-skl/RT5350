...
document.write('<div id="loading" style="display: none;"><br><br><img src="../graphics/jindutiao2.gif" width="85px" height="81px"><br><br><font color=#0000FF>Uploading firmware <br><br> Please be patient ...</font></div>');
...
<p><font id="uploadIntroduction1">Upgrade the Ralink SoC firmware to obtain new functionality. </font><font id="uploadIntroduction2" color="#ff0000">It takes about 1 minute to upload &amp; upgrade flash and be patient please. Caution! A corrupted image will hang up the system.</font> </p>
...
<tbody><tr>
  <td colspan="2" id="uploadFW" class="title">Update Firmware</td>
</tr>
<tr>
  <td id="uploadFWLocation" class="head">Location:</td>
	<td class="content"> <input name="filename" size="20" maxlength="256" type="file"> </td>
</tr>
</tbody></table>
...
<tbody><tr>
  <td colspan="2" id="uploadFWFromUSB">Update Firmware From USB Disk</td>
</tr>
<tr>
