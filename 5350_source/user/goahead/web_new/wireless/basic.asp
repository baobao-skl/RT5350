...
var hdbMode = '<% getCfgZero(1, "TxPower"); %>';
...
function initTranslation()
{
	...
	e = document.getElementById("basicHdbMode");
	e.innerHTML = _("basic hdb mode");
	e = document.getElementById("hdblow");
	e.innerHTML = _("basic hdb low");
	e = document.getElementById("hdbnormal");
	e.innerHTML = _("basic hdb normal");
	e = document.getElementById("hdbhigh");
	e.innerHTML = _("basic hdb high");
  ...
  e = document.getElementById("basicHTMixed");
	...
	e = document.getElementById("basicHTGreenField");
	e.innerHTML = _("basic ht op green");	
...
function initValue()
{
	...
	if(hdbMode == "20")
	{
		document.wireless_basic.hdbmode.options.selectedIndex = 0;
	}
	else if(hdbMode == "50")
	{
		document.wireless_basic.hdbmode.options.selectedIndex = 1;
	}
	else if(hdbMode == "100")
	{
		document.wireless_basic.hdbmode.options.selectedIndex = 2;
	}
	else
	{
		document.wireless_basic.hdbmode.options.selectedIndex = 1;
	...
	*/
	...
	if (1*radio_off == 1)
		document.wireless_basic.radioButton.value = "ON";
	else
		document.wireless_basic.radioButton.value = "OFF";
}

function hdbModeChange()
{
	document.getElementById("hdblow").style.visibility = "hidden";
	document.getElementById("hdblow").style.display = "none";
	document.getElementById("hdbnormal").style.visibility = "hidden";
	document.getElementById("hdbnormal").style.display = "none";
	document.getElementById("hdbhigh").style.visibility = "hidden";
	document.getElementById("hdbhigh").style.display = "none";
	
	if (document.wireless_basic.hdbmode.options.selectedIndex == 0) {
		document.getElementById("hdblow").style.visibility = "visible";
		document.getElementById("hdblow").style.display = "block";
	}
	else if (document.wireless_basic.hdbmode.options.selectedIndex == 1) {
		document.getElementById("hdbnormal").style.visibility = "visible";
		document.getElementById("hdbnormal").style.display = "block";
	}
	else if (document.wireless_basic.hdbmode.options.selectedIndex == 2) {
		document.getElementById("hdbhigh").style.visibility = "visible";
		document.getElementById("hdbhigh").style.display = "block";		
	}
	else
	{
		document.getElementById("hdbnormal").style.visibility = "visible";
...
<table width="540" border="0" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  <tr> 
    <td colspan="2" id="basicWirelessNet" class="title">Wireless Network</td>
  </tr>
  <tr> 
    <td id="basicRadioButton" class="head">Radio On/Off</td>
    <td class="content">
      <input type="button" name="radioButton" style="{width:120px;}" value="ON"
  ...
  <tr>
  	<td id="basicHdbMode" class="head">HDB Mode</td>
  	<td class="content">
  		<select name="hdbmode" id="hdbmode" size="1" onChange="hdbModeChange()">
        <option value="LOW" id="hdblow">Low Power</option>
        <option value="NORMAL" id="hdbnormal">Normal</option>
        <option value="HIGH" id="hdbhigh">High Power</option>        
      </select>
  	</td>	
	</tr>	
  <tr> 
    <td id="basicNetMode" class="head">Network Mode</td>
    <td class="content">
  ...
  <tr> 
    <td id="basicSSID" class="head">Network Name(SSID)</td>
    <td class="content">
  ...
  <tr> 
    <td id="basicBroadcastSSID" class="head">Broadcast Network Name (SSID)</td>
    <td class="content">
  ...
  <tr id="div_11a_channel" name="div_11a_channel">
    <td><font id="basicFreqA"  class="head">Frequency (Channel)</font></td>
    <td class="content">
  ...
  <tr id="div_11b_channel" name="div_11b_channel">
    <td><font id="basicFreqB" class="head">Frequency (Channel)</font></td>
    <td class="content">
  ...
  <tr id="div_11g_channel" name="div_11g_channel">
    <td><font id="basicFreqG" class="head">Frequency (Channel)</font></td>
    <td class="content">
  ...
  <tr id="div_abg_rate">
    <td><font id="basicRate" class="head">Rate</font></td>
    <td class="content">
...
<table id="div_11n" name="div_11n" width="540" border="0" cellspacing="1" cellpadding="3" bordercolor="#9BABBD" style="display:none">
  <tr> 
    <td colspan="2" id="basicHTPhyMode" class="title">HT Physical Mode</td>
  </tr>
  <tr>
    <td id="basicHTOPMode" class="head">Operating Mode</td>
    <td class="content">
      <input type=radio name=n_mode value="0" checked><font id="basicHTMixed">Mixed Mode&nbsp;</font>
      <input type=radio name=n_mode value="1"><font id="basicHTGreenField">Green Field</font>
    </td>
  </tr>
  <tr>
    <td id="basicHTChannelBW" class="head">Channel BandWidth</td>
    <td class="content">
  ...
  <tr>
    <td id="basicHTGI" class="head">Guard Interval</td>
    <td class="content">
  ...
  <tr>
    <td id="basicHTRDG" class="head">Reverse Direction Grant(RDG)</td>
    <td class="content">
  ...
  <tr name="extension_channel" id="extension_channel">
    <td id="basicHTExtChannel" class="head">Extension Channel</td>
    <td class="content">
  ...
  <tr>
    <td id="basicHTAMSDU" class="head">Aggregation MSDU(A-MSDU)</td>
    <td class="content">
  ...
  <tr>
    <td id="basicHTAddBA" class="head">Auto Block ACK</td>
    <td class="content">
  ...
  <tr>
    <td id="basicHTDelBA" class="head">Decline BA Request</td>
    <td class="content">
...
<table id="div_11n_plugfest" name="div_11n_plugfest" width="540" border="0" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  <tr> 
    <td colspan="2" id="basicOther" class="title">Other</td>
  </tr>
  <!--
  <tr>
  ...
  -->
  <tr>
    <td id="basicHTTxStream" class="head">HT TxStream</td>
    <td class="content">
  ...
  <tr>
    <td id="basicHTRxStream"  class="head">HT RxStream</td>
    <td  class="content">
