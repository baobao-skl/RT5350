...
<table width="540" border="0" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
  <tr> 
    <td colspan="2" id="advWireless"  class="title">Advanced Wireless</td>
  </tr>
  <tr> 
    <td id="advBGProtect" class="head">BG Protection Mode</td>
    <td  class="content">
  ...
  -->
  <tr> 
    <td id="advBeaconInterval" class="head">Beacon Interval</td>
    <td  class="content">
  ...
  <tr> 
    <td id="advShortPre" class="head">Short Preamble</td>
    <td class="content">
  ...
  <tr> 
    <td id="advShortSlot" class="head">Short Slot</td>
    <td class="content">
  ...
  <tr> 
    <td id="advTxBurst" class="head">Tx Burst</td>
    <td class="content">
  ...
  <tr> 
    <td id="advPktAggr" class="head">Pkt_Aggregate</td>
    <td class="content">
  ...
  <tr> 
    <td  id="adv80211H" class="head">IEEE 802.11H Support</td>
    <td class="content">
  ...
  <tr id="div_dfs_rdregion" name="div_dfs_rdregion">
    <td id="advRDRegion" class="head">DFS RDRegion</td>
    <td class="content">
  ...
  <tr> 
    <td id="advCountryCode" class="head">Country Code</td>
    <td class="content">
  ...
  <tr id="div_carrier_detect" name="div_carrier_detect">
    <td id="advCarrierDetect" class="head">Carrier Detect</td>
    <td class="content">
...
<table width="540" border="0" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
  <tr> 
    <td colspan="2" id="advWiFiMM"  class="title">Wi-Fi Multimedia</td>
  </tr>
  <tr> 
  ...
  <tr id="div_apsd_capable" name="div_apsd_capable">
    <td id="advAPDS" class="head">APSD Capable</td>
    <td class="content">
  ...
  <tr id="div_dls_capable" name="div_dls_capable">
    <td id="advDLS" class="head">DLS Capable</td>
    <td class="content">
  ...
  <tr> 
    <td id="advWMMParameter" class="head">WMM Parameters</td>
    <td class="content">
...
<table id="div_m2u" name="div_m2u" width="540" border="0" cellspacing="1" cellpadding="3" vspace="2" hspace="2" bordercolor="#9BABBD">
  <tr> 
    <td colspan="2" id="advMul2UniConver"  class="title">Multicast-to-Unicast Converter</td>
  </tr>
  <tr> 
    <td id="advMul2Uni"  class="head">Multicast-to-Unicast</td>
    <td  class="content">
